function calculateRating() {
    var score = 0;
    var totalQuestions = 80; // Adjust this number if questions are added/removed
    ...
    if (percentage >= 80) {
        ...
        resultMessage = 'Good job! You have a solid understanding of online safety,\nbut there is room for improvement.';
    } else {
        resultMessage = 'Needs Improvement.\nConsider learning more about online safety.';
    }
